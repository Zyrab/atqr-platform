...
function CheckboxLabel({ label, id, containerClassName, className, ...props }: CheckboxLabelProps) {
  ...
  return (
    <div className={cn("flex items-center gap-2 p-2", containerClassName)}>
...
export { Input, Label, Checkbox, CheckboxLabel };
